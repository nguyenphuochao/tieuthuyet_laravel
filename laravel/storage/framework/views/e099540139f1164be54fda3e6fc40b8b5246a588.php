    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse navbar-right">
                <ul class="control nav navbar-nav ">
                    <li>
                        <a style="color:white" href="<?php echo e(route('review')); ?>"><i class="fa-solid fa-eye"></i> Review truyện</a>
                    </li>
                    <?php /* <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo e(route('danhsach.truyenfull')); ?>" title="Truyện Full"><i class="glyphicon glyphicon-ok"></i> Truyện full</a></li>
                        </ul>
                    </li> */ ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-2" role="menu"
                            ...
                            <?php endforeach; ?>
                                <li class="col-md-6">
                                    <a href="<?php echo e(route('danhsach.truyenhotnhat')); ?>" title="Truyện Full">Truyện HOT nhất</a>
                                </li>
                                <li class="col-md-6">
                                    <a href="<?php echo e(route('danhsach.truyenmoi')); ?>" title="Truyện mới cập nhật">Truyện mới nhất</a>
                                </li>
                                <li class="col-md-6">
                                    <a href="<?php echo e(route('danhsach.truyenhot')); ?>" title="Truyện Hot">Tiểu thuyết đọc nhiều</a>
                                </li>
                                <li class="col-md-6">
                                    <a href="<?php echo e(route('danhsach.truyenfull')); ?>" title="Truyện Full">Truyện full</a>
                                </li>
                    ...
                    <?php else: ?>
                        <li class="dropdown user user-menu">
                            <a style="color: white" href="<?php echo e(url("/login")); ?>"><i class="glyphicon glyphicon-user"></i> Tài khoản </a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
    ...
    <div class="sidebar-content">
        ...
        <div class="row">
            <div class="col-lg-12 list-story-sidebar" style="font-size: 11px">
                ...
                href="<?php echo e(route('review')); ?>">REVIEW TRUYỆN</a>
                <?php /* <p>DANH SÁCH</p>
                ...
                <ul class="list-unstyled" style="display:flex;flex-wrap:wrap">
                    ...
                    <?php endforeach; ?>
                    <li style="width: 50%">
                        <a href="<?php echo e(route('danhsach.truyenhotnhat')); ?>" title="Truyện Full"><i class="glyphicon glyphicon-heart"></i> Truyện HOT nhất</a>
                    </li>
                    <li style="width: 50%">
                        <a href="<?php echo e(route('danhsach.truyenmoi')); ?>" title="Truyện mới cập nhật"><i class="glyphicon glyphicon-refresh"></i> Truyện mới nhất</a>
                    </li>
                    <li style="width: 50%">
                        <a href="<?php echo e(route('danhsach.truyenhot')); ?>" title="Truyện Hot"><i class="glyphicon glyphicon-eye-open"></i> Tiểu thuyết đọc nhiều</a>
                    </li>
                    <li style="width: 50%">
                        <a href="<?php echo e(route('danhsach.truyenfull')); ?>" title="Truyện Full"><i class="glyphicon glyphicon-ok"></i> Truyện Full</a>
                    </li>
                </ul>
            </div>
        </div>
