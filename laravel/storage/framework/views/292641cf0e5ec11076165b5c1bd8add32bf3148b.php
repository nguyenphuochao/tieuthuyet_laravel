...
<div class="box box-primary"><div class="box-body">
    <form action="<?php echo e(route('dashboard.story.store')); ?>" method="POST" id="dqhStoryForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>Review truyện (Nhập vào nếu có)</label>
            <textarea class="form-control editor" placeholder="Nhập vào nội dung bạn muốn review nếu có" rows="10" name="txtReviewed"><?php echo e(old('txtReviewed')); ?></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" placeholder="Nhập vào cảnh báo nếu có" class="form-control" name="is18" value= "<?php echo e(old('is18')); ?>">
        </div>
        <div class="form-group">
            <label>Giới hạn đọc đến chương</label>
            <input type="number" placeholder="Nhập vào số chương giới hạn. Ví dụ: 20" class="form-control" name="chapter_limit" value="<?php echo e(old('chapter_limit')); ?>">
        </div>
        <div class="form-group">
            <label>Hiện thông báo</label>
            <input type="text" placeholder="Nhập vào để hiện thông báo trên trang đọc truyện" class="form-control" name="popup" value="<?php echo e(old('popup')); ?>">
        </div>
