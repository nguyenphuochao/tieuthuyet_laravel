            ...
            <div class="row">
                ...
                <div class="contact col-xs-12 col-lg-3 col-md-12"
                    ...
                    <div class="text-left">
                        ...
                        <p style="font-size: 12px;font-weight: bold; color: #000000; margin-bottom:8px;">Email:
                            brightstar24h@gmail.com</p>
                        <div class="fade-loop" style="font-size: 12px;font-weight: bold; color: #000000;">
                            <a href="https://www.facebook.com/thongtinxuphat"><i class="fa-brands fa-facebook"></i>Tiểu
                                Thuyết</a>
                        </div>
                    </div>
                </div>
                ...
                <ul class="col-xs-12 col-lg-12 policy" style="margin-top: 12px">
                    <li class="text-center">
                        <a href="<?php echo e(url('contact')); ?>" title="Liên hệ">Liên hệ </a>-<a href="<?php echo e(url('dieu-khoan')); ?>"
