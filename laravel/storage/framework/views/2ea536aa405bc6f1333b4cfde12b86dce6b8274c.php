...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-lg-8" style="padding-bottom:120px">
        ...
        <form method="POST" id="dqhStoryFormLeech">
            ...
            <button type="submit" id="subF" class="btn btn-default">Chạy</button>
                ...
                success: function(data){
                    ...
                    $.each(data.chapters,function(k, v){
                        $.ajax({
                            ...
                            success: function(data){
                                $("#log").append("Chapter "+(k+1)+" -> " + data.title + " -> " + data.status +  "<br>");
                                if(k == len)
                                {
                                    $("#log").append("== HOÀN THÀNH == <br/>");
                                    alert("Hoàn thành!");
                                    $('#subF').attr("disabled",false);
                                }
                            },
                        })
                        .fail(function(){
