<?php $__env->startSection('title', 'Chỉnh sửa vấn đề bản quyền'); ?>
...
<div class="box box-primary"><div class="box-body">
        ...
        <form action="<?php echo e(route('dashboard.setting.update')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="license_content" id="introduct_content" class="form-control editor" cols="30" rows="20"><?php echo e(old('license_content', \App\Option::getvalue('license_content'))); ?></textarea>
            </div>
