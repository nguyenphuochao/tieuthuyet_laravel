<?php $__env->startSection('title', 'Chỉnh sửa giới thiệu'); ?>
...
<div class="box box-primary"><div class="box-body">
        ...
        <form action="<?php echo e(route('dashboard.setting.update')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="introduct_content" id="introduct_content" class="form-control editor" cols="30" rows="20"><?php echo e(old('introduct_content', \App\Option::getvalue('introduct_content'))); ?></textarea>
            </div>
