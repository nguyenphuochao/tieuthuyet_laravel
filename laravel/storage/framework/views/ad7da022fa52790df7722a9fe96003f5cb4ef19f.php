                        ...
                        <div class="col-xs-3">
                            <div>
                                <?php if($story->image && file_exists(public_path($story->image))): ?>
                                    <img itemprop="image" class="visible-sm-block visible-md-block visible-lg-block" src="<?php echo e(url($story->image)); ?>"  width="100" height="126" alt="<?php echo e($story->name); ?>">
                                <?php else: ?>
                                    <img itemprop="image" class="visible-sm-block visible-md-block visible-lg-block" src="<?php echo e(url('/images/no_signal/no-signal-thumb.jpg')); ?>"  width="100" height="126" alt="<?php echo e($story->name); ?>">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-xs-7">
