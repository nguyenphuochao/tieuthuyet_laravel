...
<body class="hold-transition skin-blue sidebar-mini">
      <div class="wrapper" style="background-color: #ecf0f5;">
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo Auth::user()->avatar; ?>" class="user-image" alt="User Image">
                        <?php else: ?>
                        <img src="http://www.gravatar.com/avatar/<?php echo md5( Auth::user()->email ); ?>?s=160&d=mp" class="user-image" alt="User Image">
                        <?php endif; ?>
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                      <?php if(Auth::user()->avatar): ?>
                        <img src="<?php echo Auth::user()->avatar; ?>" class="img-circle" alt="User Image">
                        <?php else: ?>
                        <img src="http://www.gravatar.com/avatar/<?php echo md5( Auth::user()->email ); ?>?s=160&d=mp" class="img-circle" alt="User Image">
                        <?php endif; ?>
        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <?php if( Auth::user()->isAdmin()): ?>
              <li class="treeview">
                <a href="<?php echo e(URL::route('dashboard.violate.index')); ?>">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                  <span>Báo cáo vi phạm</span>
                  <small class="label pull-right bg-red"><?php echo \App\Violate::count(); ?></small>
                </a>
              </li>
              ...
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                      <li>
                          <a href="#"><i class="fa fa-plus-square-o"></i> Danh sách truyện<i class="fa fa-angle-left pull-right"></i></a>
                          <ul class="treeview-menu">
                              <li>
                                  <a href="<?php echo e(URL::route('dashboard.story.index')); ?>"><i class="fa fa-circle-o"></i> Đã phê duyệt</a>
                              </li>
                              <li>
                                  <a href="<?php echo e(URL::route('checkStory')); ?>"><i class="fa fa-circle-o"></i> Chưa phê duyệt</a>
                              </li>
                          </ul>
                      </li>
                      <li>
              ...
              <?php /* <li class="treeview">
                <a href="#"><i class="fa fa-file-image-o" aria-hidden="true"></i> Slider <i class="fa fa-angle-left pull-right"></i>
                <ul class="treeview-menu">
                    <li>
                        <a href="<?php echo e(URL::route('dashboard.slider.index')); ?>"><i class="fa fa-circle-o"></i> Danh sách slider</a>
                    </li>
                    <li>
                        <a href="<?php echo e(URL::route('dashboard.slider.create')); ?>"><i class="fa fa-circle-o"></i> Thêm slider</a>
                    </li>
                </ul>
            </li> */ ?>
              <li class="treeview">
              ...
              <li class="treeview">
                        <a href="<?php echo e(route('dashboard.setting.private')); ?>"><i class="fa fa-pencil"></i> Chỉnh sửa chính
                            sách bảo mật</a>
              </li>
              <li class="treeview">
                        <a href="<?php echo e(route('dashboard.setting.introduct')); ?>"><i class="fa fa-pencil"></i> Chỉnh sửa giới thiệu</a>
              </li>
              <li class="treeview">
                        <a href="<?php echo e(route('dashboard.setting.regulation')); ?>"><i class="fa fa-pencil"></i> Chỉnh sửa quy định về nội dung</a>
              </li>
              <li class="treeview">
                        <a href="<?php echo e(route('dashboard.setting.licenseIssues')); ?>"><i class="fa fa-pencil"></i> Chỉnh sửa vấn đề bản quyền</a>
              </li>
              <li class="treeview">
        ...
        <!-- /.content-wrapper -->
        <footer class="main-footer" style="width: 100%; position: fixed; bottom: 0%;">
          <div class="pull-right hidden-xs">
            <b>Phiên bản:</b> 2.0.3
          </div>
          <strong>Copyright &copy; 2015-<?php echo date('Y'); ?></a>.</strong> All rights
          reserved.
        </footer>
