...
<body>
                ...
                <div class="row">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo e(route('violate')); ?>" method="POST" id="violate">
                    ...
                    <ul class="col-xs-12 col-lg-12 policy" style="margin-top: 12px">
                        <li class="text-center" style="color: white">
                            <a style="color:white" href="<?php echo e(url('contact')); ?>" title="Liên hệ">Liên hệ </a>-<a style="color: white"
                                href="<?php echo e(url('dieu-khoan-su-dung')); ?>" title="Terms of Service"> Điều
                                khoản </a>-<a style="color: white" href="<?php echo e(url('chinh-sach-bao-mat')); ?>" title="Terms of Service"> Chính
                                sách bảo mật </a>-<a style="color: white" href="<?php echo e(url('gioi-thieu')); ?>" title="Terms of Service"> Giới
                                thiệu </a>-<a style="color: white" href="<?php echo e(url('quy-dinh-ve-noi-dung')); ?>" title="Terms of Service"> Quy
                                định về nội dung </a>-<a style="color: white" href="<?php echo e(url('van-de-ve-ban-quyen')); ?>"
    ...
    <script src="<?php echo e(asset('assets/js/nguyenphuochao.js')); ?>"></script>
