              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @else
                        <img src="http://www.gravatar.com/avatar/{!! md5( Auth::user()->email ) !!}?s=160&d=mp" class="user-image" alt="User Image">
                        @endif
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                      @if(Auth::user()->avatar)
                        ...
                        @else
                        <img src="http://www.gravatar.com/avatar/{!! md5( Auth::user()->email ) !!}?s=160&d=mp" class="img-circle" alt="User Image">
                        @endif
        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              @if( Auth::user()->isAdmin())
              <li class="treeview">
                <a href="{{ URL::route('dashboard.violate.index')}}">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                  <span>Báo cáo vi phạm</span>
                  <small class="label pull-right bg-red">{!!\App\Violate::count()!!}</small>
                </a>
              </li>
              ...
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                      <li>
                          ...
                          <ul class="treeview-menu">
                              <li>
                                  <a href="{{ URL::route('dashboard.story.index')}}"><i class="fa fa-circle-o"></i> Đã phê duyệt</a>
                              </li>
                              <li>
                                  <a href="{{ URL::route('checkStory')}}"><i class="fa fa-circle-o"></i> Chưa phê duyệt</a>
                              </li>
                          </ul>
                      </li>
                      <li>
              ...
              {{-- <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="{{ URL::route('dashboard.slider.index')}}"><i class="fa fa-circle-o"></i> Danh sách slider</a>
                    </li>
                    <li>
                        <a href="{{ URL::route('dashboard.slider.create')}}"><i class="fa fa-circle-o"></i> Thêm slider</a>
                    </li>
                </ul>
            </li> --}}
              <li class="treeview">
              ...
              <li class="treeview">
                        <a href="{{route('dashboard.setting.private')}}"><i class="fa fa-pencil"></i> Chỉnh sửa chính
                            sách bảo mật</a>
              </li>
              <li class="treeview">
                        <a href="{{route('dashboard.setting.introduct')}}"><i class="fa fa-pencil"></i> Chỉnh sửa giới thiệu</a>
              </li>
              <li class="treeview">
                        <a href="{{route('dashboard.setting.regulation')}}"><i class="fa fa-pencil"></i> Chỉnh sửa quy định về nội dung</a>
              </li>
              <li class="treeview">
                        <a href="{{route('dashboard.setting.licenseIssues')}}"><i class="fa fa-pencil"></i> Chỉnh sửa vấn đề bản quyền</a>
              </li>
              <li class="treeview">
